...
The first line is the executable and it goes at 0. The rest are all
packed on the end, preceeded by a 4-byte bytecount which is the size+4, to
account for the length itself. The program can then easily step through the
ordered data files and find them all.
